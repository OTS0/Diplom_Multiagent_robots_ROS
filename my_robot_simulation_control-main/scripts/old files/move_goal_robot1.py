...
class SimpleController():  
    ...
    def __init__(self):  
        ...
        self.subscriber =rospy.Subscriber('robot1/odom', Odometry, self.pose_callback)
        self.subscriber_target =rospy.Subscriber('robot1/goal/point', Point, self.target_callback)
