...
from alghorithms.neighbors import find_neighbors
...
def astar(start_index, goal_index, width, height, costmap, resolution, origin):
  ''' 
  ...
  # set - контейнер без повторяющихся элементов
  ...
  return shortest_path, path_found
