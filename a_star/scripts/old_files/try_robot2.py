...
class Astar_planner():  
    ...
    def __init__(self):  
        rospy.init_node('Global_planning2', anonymous=True)  
        ...
        self.subscriber_odom =rospy.Subscriber('/robot2/odom', Odometry, self.start_pose_callback, queue_size=1)
        self.subscriber_goal =rospy.Subscriber('/robot2/goal/point', Point, self.goal_pose_callback, queue_size=1)

        self.publisher = rospy.Publisher('/robot2/path', Coords, queue_size=1)
        self.sub_from_robot =rospy.Subscriber('/robot2//answer/getpath', Bool, self.robot_callback)  
